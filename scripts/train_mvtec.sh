...
LOG_FILE="${LOG_DIR}/train_mvtec_paladin_${TIMESTAMP}.log"
...
deepspeed --master_port 28400 train_mvtec.py \
    --model model_paladin \
    --stage 1 \
    --save_path ./mvtec_paladin/train_mvtec/ \
    --log_path ./mvtec_paladin/train_mvtec/log_rest/ \
